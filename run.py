...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='TFDPNet')
    ...
    key_frequency_map = {'ETTh1':24,'ETTh2':24,'ETTm1':96,'ETTm2':96,'electricity':168,'weather':144,'traffic':168,'Solar':144,'PEMS':288,'Flight':24,}
    ...
    parser.add_argument('--d_model_frequency', type=int, default=128, help='dimension of model')
    ...
    parser.add_argument('--key_frequency', type=int, default=24, help='key frequency size')
    ...
    parser.add_argument('--alpha', type=float, default=0.7, help='Frequency filter threshold')
    parser.add_argument('--top_p', type=float, default=0.5, help='Temporal clustering threshold')
    ...
    args.key_frequency = key_frequency_map[args.data]
